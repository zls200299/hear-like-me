<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      <el-table-column label="编码" prop="scenarioCode" width="120" />
      <el-table-column label="中文名" prop="nameCn" min-width="120" />
      <el-table-column label="通道数" prop="nChannels" width="80" align="center" />
      <el-table-column label="频率范围" min-width="140">
        <template #default="{ row }">{{ row.fLo }} - {{ row.fHi }} Hz</template>
      </el-table-column>
      <el-table-column label="默认示例音" prop="defaultSampleCode" width="110" />
        ...
        <el-row :gutter="16">
          ...
          <el-col :span="8">
            <el-form-item label="通道数" prop="nChannels">
              <el-input-number v-model="form.nChannels" :min="1" :max="22" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="频率下限">
              <el-input-number v-model="form.fLo" :min="1" :step="10" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="频率上限">
              <el-input-number v-model="form.fHi" :min="100" :step="10" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="包络截止">
              <el-input-number v-model="form.envCut" :min="20" :max="500" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="电流扩散">
              <el-input-number v-model="form.spread" :min="0" :max="1" :step="0.05" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="背景噪声">
              <el-input-number v-model="form.noiseLevel" :min="0" :max="1" :step="0.05" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="默认示例音">
              <el-select v-model="form.defaultSampleCode" clearable style="width: 100%">
                <el-option label="vowel" value="vowel" />
                <el-option label="tone" value="tone" />
                <el-option label="melody" value="melody" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="6">
