 ...
 */
@RestController
@RequestMapping("/audio/processing/task/event")
@Api(value = "")
@Slf4j
public class AudioProcessingTaskEventController {
    ...
    public R<IPage<AudioProcessingTaskEvent>> getListByPage(
    ...
    @Transactional
    public R addOrUpdate(@RequestBody AudioProcessingTaskEventDto audioProcessingTaskEventDto){
        return iAudioProcessingTaskEventService.addOrUpdate(audioProcessingTaskEventDto);
    }
