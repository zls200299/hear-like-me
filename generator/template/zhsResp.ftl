package ${content.resp.classPackage};
...
@ToString
@NoArgsConstructor
@ApiModel(value = "${content.resp.className}")
public class ${content.resp.className} implements Serializable {
        //表字段
<#list content.resp.attrs as item>
    <#if item.field == "id">
