package ${content.detailResp.classPackage};
...
@ToString
@NoArgsConstructor
@ApiModel(value = "${content.detailResp.className}")
public class ${content.detailResp.className} implements Serializable {
        //表字段
<#list content.detailResp.attrs as item>
    <#if item.field == "id">
