...
public class MetaConfig {
    ...
    /** 生成模板的名字 */
    private String templateName = Constant.TEMPLATE_NAME_TIME;
    /** 是否覆盖原文件 */
     ...
     *
     */
    public MetaConfig(ObservableList<TableAttributeKeyValue> item) {
        super();
     ...
     *
     */
    public MetaConfig(ObservableList<TableAttributeKeyValue> item, String templateName, boolean overrideFile) {
        super();
        if (item != null && !item.isEmpty()) {
            tableItem.addAll(item);
        }
