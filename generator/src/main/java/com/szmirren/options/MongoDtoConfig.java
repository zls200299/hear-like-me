 ...
 *
 */
public class MongoDtoConfig {
	/** 生成模板的名字 */
	private String templateName = Constant.TEMPLATE_NAME_MONGO_DTO_ENTITY;
	/** 字段使用驼峰命名 */
	...
	// -----------------不在保存配置范围的属性-----------------------
	/** 存储信息table里面的所有属性 */
	private ObservableList<TableAttributeEntity> mongoPropertyValues;
	/** 表的别名 */
	 ...
	 * @param obj
	 */
	public MongoDtoConfig(JSONObject obj) {
		super();
	...
	public ObservableList<TableAttributeEntity> getTblPropertyValues() {
		return mongoPropertyValues;
	}
	public void setMongoPropertyValues(ObservableList<TableAttributeEntity> tblPropertyValues) {
		this.mongoPropertyValues = tblPropertyValues;
	}
	...
	public String toString() {
		return "EntityConfig [templateName=" + templateName + ", fieldCamel=" + fieldCamel + ", overrideFile=" + overrideFile
				+ ", mongoPropertyValues=" + mongoPropertyValues + ", tableAlias=" + tableAlias + ", primaryKey=" + primaryKey + "]";
	}
