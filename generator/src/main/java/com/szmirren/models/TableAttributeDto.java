 ...
 *
 */
public class TableAttributeDto implements Comparable<TableAttributeDto> {
	// ---------------------------表格需要的属性---------------------------------
	/** 是否创建 */
	 ...
	 *          字段名称
	 */
	public TableAttributeDto(String javaType, String fieldName) {
		super();
		initComboBox();
	...
	@Override
	public int compareTo(TableAttributeDto obj) {
