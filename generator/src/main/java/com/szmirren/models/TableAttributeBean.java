 ...
 *
 */
public class TableAttributeBean implements Comparable<TableAttributeBean> {
	// ---------------------------表格需要的属性---------------------------------
	/** 是否创建 */
	 ...
	 *          字段名称
	 */
	public TableAttributeBean(String javaType, String fieldName) {
		super();
		initComboBox();
	...
	@Override
	public int compareTo(TableAttributeBean obj) {
