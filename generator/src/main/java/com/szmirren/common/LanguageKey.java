...
public interface LanguageKey {
	...
	/** 新建mongodb连接 */
	static final String PAGE_CREATE_MONGODB_CONNECTION = "page.createMongodbConnection";
	static final String INDEX_MONGODB_CONNECTION = "index.mongodbConnection";
	static final String INDEX_CHANGE_DATASOURCE = "index.changeDatasource";
	/** 修改数据库连接 */
	...
	static final String INDEX_TXT_MONGO_COllECTION_NAME = "index.mongoCollectionName";
	/** 首页-实体类包名 */
	static final String INDEX_LBL_ENTITY_PACKAGE = "index.lblEntityPackage";
	static final String INDEX_MONGODB_DTO_PACKAGE_NAME = "index.mongodbDtoPackage";
	/** 首页-Bean实体类包名 */
	...
	static final String INDEX_LBL_MONGO_DTO_NAME = "index.lblMongoDtoName";
	/** 首页-createDto实体类类名 */
	static final String INDEX_LBL_CREATE_DTO_NAME = "index.lblCreateDtoName";
	/** 首页-createDto实体类包名 */
	static final String INDEX_LBL_CREATE_DTO_PACKAGE = "index.lblCreateDtoPackage";
	/** 首页-updateDto实体类类名 */
	static final String INDEX_LBL_UPDATE_DTO_NAME = "index.lblUpdateDtoName";
	/** 首页-updateDto实体类包名 */
	static final String INDEX_LBL_UPDATE_DTO_PACKAGE = "index.lblUpdateDtoPackage";
	/** 首页-respDto实体类类名 */
	static final String INDEX_LBL_RESP_DTO_NAME = "index.lblRespDtoName";
	/** 首页-respDto实体类包名 */
	static final String INDEX_LBL_RESP_DTO_PACKAGE = "index.lblRespDtoPackage";
	/** 首页-updateDto实体类类名 */
	static final String INDEX_LBL_QUERY_DTO_NAME = "index.lblQueryDtoName";
	/** 首页-updateDto实体类包名 */
	static final String INDEX_LBL_QUERY_DTO_PACKAGE = "index.lblQueryDtoPackage";
	/** 首页-Bean实体类类名 */
	...
	/** 首页-Request包名 */
	static final String INDEX_LBL_REQUEST_PACKAGE = "index.lblRequestPackage";
	/** 首页-Response包名 */
	static final String INDEX_LBL_RESPONSE_PACKAGE = "index.lblResponsePackage";
	/** 首页-AddReq类名模板 */
	static final String INDEX_LBL_ADD_REQ_NAME = "index.lblAddReqName";
	/** 首页-UpdateReq类名模板 */
	static final String INDEX_LBL_UPDATE_REQ_NAME = "index.lblUpdateReqName";
	/** 首页-QueryReq类名模板 */
	static final String INDEX_LBL_QUERY_REQ_NAME = "index.lblQueryReqName";
	/** 首页-Resp类名模板 */
	static final String INDEX_LBL_RESP_NAME = "index.lblRespName";
	/** 首页-DetailResp类名模板 */
	static final String INDEX_LBL_DETAIL_RESP_NAME = "index.lblDetailRespName";
	/** 首页-单元测试类名 */
	...
	static final String CONN_MONGO_PORT = "conn.mongoPort";
	/** 数据库连接-数据库类型 */
