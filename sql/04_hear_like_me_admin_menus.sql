...
('2024', '挑战记录', '2004', '3', 'record', 'hlm/challenge/record/index', '', 'HlmChallengeRecord', 1, 0, 'C', '0', '0', 'hlm:challenge:record:list', 'form', 'admin', sysdate(), '', NULL, '听音挑战答题记录'),
('2028', '挑战统计', '2004', '4', 'stats', 'hlm/challenge/stats/index', '', 'HlmChallengeStats', 1, 0, 'C', '0', '0', 'hlm:challenge:stats', 'chart', 'admin', sysdate(), '', NULL, '听音挑战答题统计看板');
...
('2016', '音频任务', '2000', '9', 'audio-task', 'hlm/audio-task/index', '', 'HlmAudioTask', 1, 0, 'C', '0', '0', 'hlm:task:list', 'log', 'admin', sysdate(), '', NULL, '音频处理任务运维');

-- P2：点读学习 + 用户历史占位
INSERT INTO sys_menu VALUES
('2020', '点读学习', '2000', '4', 'read-aloud', NULL, '', '', 1, 0, 'M', '0', '0', '', 'table', 'admin', sysdate(), '', NULL, '点读学习'),
...
('2025', '模拟历史', '2023', '1', 'sim-history', 'hlm/placeholder/index', '{"phase":"P2","module":"sim-history"}', 'HlmSimHistory', 1, 0, 'C', '0', '0', 'hlm:history:sim', 'date', 'admin', sysdate(), '', NULL, 'P2-占位');
